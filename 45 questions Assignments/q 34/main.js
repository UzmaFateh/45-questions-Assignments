...
var pizzas = ["pepperoni", "tandoori chicken", "marinara"];
pizzas.forEach(function (pizza) { console.log("i like ".concat(pizza, " pizza.")); });
console.log("These ".concat(pizzas, " pizzas with extra cheese,\nare my my favorite, \nI really like pepperoni pizza"));
